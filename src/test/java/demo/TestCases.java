...
public class TestCases extends ExcelDataProvider { // Lets us read the data
        ...
        public void testCase02() throws InterruptedException {
                ...
                WebElement movies = wait
                                .until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//a[@title='Films']")));
                ...
                if (ratings.size() > 0) {
                        ...
                        sAssert.assertTrue(assertArat.equals("U/A16+"), "Rating mismatch");

                        WebElement assertMovieType = driver
                                        .findElement(By.xpath("(//span[contains(text(),'Drama')])[3]"));
                        String expectedMovieType = "Drama";
                        String actualMovieType = assertMovieType.getText();
                        boolean movieTypeIsMatchingOrNot = actualMovieType.contains(expectedMovieType);
                        sAssert.assertTrue(movieTypeIsMatchingOrNot, "Movie type mismatch");
        ...
        public void testCase03() throws InterruptedException {
                ...
                // driver.findElement(By.xpath("(//div[@id='scroll-container'])[1]"));
                // WebElement nextButtonForFirstcolumn =
                // driver.findElement(By.xpath("(//button[contains(@class,'yt-spec-button-shape-next
                // yt-spec-button-shape-next--text')])[6]"));
        ...
        public void testCase04() throws InterruptedException {
                ...
                wWait.until(ExpectedConditions.presenceOfAllElementsLocatedBy(
                ...
                for (int i = 0; i < postBodies.size() && postsProcessed < 3; i++) {
                        ...
                        if (i < likes.size() && likes.get(i).isDisplayed()) {
                                ...
                                String likesCountStr = likesCount.getText().replaceAll(",", ""); // Remove commas if
                                                                                                 // present
                                likesCountInt = likesCountStr.isEmpty() ? 0 : Integer.parseInt(likesCountStr); // Convert
                                                                                                               // to
                                                                                                               // integer
                        }
